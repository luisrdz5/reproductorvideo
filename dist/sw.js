...
self.addEventListener('fetch', function (event) {
  ...
  event.respondWith(cachedResponse(request)); //Actualizamos el cache 
...
function _cachedResponse() {
  _cachedResponse = _asyncToGenerator(
  /*#__PURE__*/
...
function _updateCache() {
  _updateCache = _asyncToGenerator(
  /*#__PURE__*/
